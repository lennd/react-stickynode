...
var Sticky = (function (_Component) {
    ...
    _createClass(Sticky, [{
        ...
        key: 'handleOuterRef',
        value: function handleOuterRef(ref) {
            this.outerRef = ref;
        }
    }, {
        key: 'handleInnerRef',
        value: function handleInnerRef(ref) {
            this.innerRef = ref;
        }
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'div',
                { ref: this.handleOuterRef, className: outerClasses, style: outerStyle },
                _react2['default'].createElement(
                    'div',
                    { ref: this.handleInnerRef, className: 'sticky-inner-wrapper', style: innerStyle },
                    this.props.children
                )
            );
        }
